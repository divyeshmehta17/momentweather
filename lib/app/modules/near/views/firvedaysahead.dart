...
class FiveDaysAhead extends GetView<NearController> {
  ...
  FiveDaysAhead({Key? key}) : super(key: key);
  @override
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                String dateString =
                    controller.weatherData['daily']['time'][index].toString();
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                '${controller.weatherData['daily']['temperature_2m_max'][index].toString()} °C',
                                style: TextStyleUtil.SFPro400(
                                  fontSize: 40.kh,
                                  color:
                                      const Color.fromARGB(60, 235, 235, 245),
                                ),
                              ),
                            ),
                            Padding(
                              ...
                              child: Container(
                                ...
                                width: 1.kw,
                                color:
                                    const Color(0xffebebf54d).withOpacity(0.3),
                              ),
                            ),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
